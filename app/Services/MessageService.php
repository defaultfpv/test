...
class MessageService
{
    ...
    {
        $promt = 'Привет! Ты AI-помощник интернет зоомагазина. Ты должен внимательно изучить массив товаров, а также запрос клиента, который я пришлю в конце, и вернуть максимально релевантный ответ, строго в таком формате - ["Текстовый ответ клиенту",[id не более трех товаров через запятую]. Без лишних символов или разметок(недопускается: php```  ```). Вот массив товаров';
